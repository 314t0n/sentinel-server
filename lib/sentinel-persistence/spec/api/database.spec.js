...
describe("Database", function () {
    ...
    describe("registerEvents()", function () {
        xit("should call communication .on() with correct event id\'s", function () {
            // GIVEN
            ...
            communication.on.and.callFake(function (event, repo, method) {
                expect(accepted.indexOf(event) > -1).toBe(true);
            });
    ...
    describe("close()", function () {
        xit("should call communication .close()", function () {
            // GIVEN
