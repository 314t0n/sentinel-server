...
describe("Crud Repository", function () {
    ...
    describe(".findById()", function () {
        it("should call correct database methods", function () {
            ...
            var filter = function (filterParams) {
                expect(filterParams).toEqual({_id: id});
                return {
                    first: first
                }
            };
    ...
    describe(".add()", function () {
        it("should call correct database methods", function () {
            ...
            responseHandler.handleResponse.and.callFake(function (query, resposne) {
                resposne(null, entity);
            });
    ...
    describe(".update()", function () {
        it("should call correct database methods", function () {
            ...
            // THEN
            expect(databaseProvider.update).toHaveBeenCalledWith(entityName, {_id: entity._id}, entity);
            expect(response).toHaveBeenCalledWith(null, entity);
        });
